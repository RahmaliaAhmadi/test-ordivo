  ...
  <div id="app" class="flex container h-screen w-full">
    ...
    <div class="lg:w-1/5 border-r border-lighter px-2 lg:px-6 py-2 flex flex-col justify-between">
      ...
      <div class="lg:w-full relative">
        <button @click="dropdown = true" class="flex items-center w-full hover:bg-lightblue rounded-full p-2 focus:outline-none">
          <img src="rahma.png" class="w-10 h-10 rounded-full border border-lighter" />
          <div class="hidden lg:block ml-4">
            <p class="text-sm font-bold leading-tight"> Rahmalia Ahmadi </p>
            <p class="text-sm leading-tight"> @rahmalia_ahmadi </p>
          </div>
    ...
    <div class="w-full md:w-1/2 h-full overflow-y-scroll">
      ...
      <div class="px-5 py-3 border-b-8 border-lighter flex">
        <div class="flex-none">
          <img src="rahma.png" class="flex-none w-12 h-12 rounded-full border border-lighter"/>
        </div>
      ...
      <div class="flex flex-col-reverse">
        <div v-for="tweet in tweets" class="w-full p-4 border-b hover:bg-lighter flex">
          <div class="flex-none mr-4">
            <img src="rahma.png" class="h-12 w-12 rounded-full flex-none"/>
          </div>
          <div class="w-full">
            <div class="flex items-center w-full">
              <p class="font-semibold"> Rahmalia Ahmadi </p>
              <p class="text-sm text-dark ml-2"> @rahmalia_ahmadi </p>
              <p class="text-sm text-dark ml-2">{{currentDateTime()}} </p>
...
export default {
  ...
  data() {
    return {
      ...
      trending: [
         {
          top: "Trending Ecommerce",
          title: "Website",
          bottom: "Orderonline.id",
        },
        { top: "Music", title: "Tulus- Hati Hati Dijalan", bottom: "135K Tweets" },
        { top: "Koding", title: "VueJS", bottom: "40k tweets" },
        { top: "Trending in Indonesia", title: "Minyak Turun", bottom: "40k tweets" },
        { top: "Trending", title: "Teknologi Meningkat", bottom: "25.4k tweets" },
      ],
      tweets: [
        {content: 'Hello! Im Doing Test In Ordivo'}
      ],
      tweet: {content: ''}
    }
  },
