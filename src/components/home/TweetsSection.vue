  ...
  >
    ...
    >
      <div class="profile flex-none">
        <img src="rahma.png" class="flex-none" />
      </div>
      <div class="content ml-3">
        <div class="user-info d-flex items-center">
          <p class="follow-name">Rahmalia Ahmadi</p>
          <p class="follow-handle ml-2">@rahmalia_ahmadi</p>
          <p class="follow-time ml-2">{{moment(date).format('YYYY-MM-DD')}}</p>
          <font-awesome-icon
            class="more ml-auto"
